...
class GenderCreateTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier,
            forIndexPath: indexPath) as! GenderCreateTableViewCell
        // Configure the cell...
        cell.genderLabel.text = genderNames[indexPath.row]
        let checkMarkToDisplay = NSUserDefaults.standardUserDefaults().integerForKey("createLastSelection")
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        NSUserDefaults.standardUserDefaults().setInteger(indexPath.row, forKey: "createLastSelection")
        NSUserDefaults.standardUserDefaults().setInteger(indexPath.row, forKey: "createGender")
    }
